    ...
    if (session?.user.nivelUsuario == 4) {
        return (
            <div className='card shadow-1'>
                <div className='text-center'>
                    ...
                    <h5 style={{ color: 'var(--surface-700)' }}>{estudiante.Persona.Paterno} {estudiante.Persona.Materno} {estudiante.Persona.Nombres}</h5>
                    <h6 className='mt-0' style={{ color: 'var(--surface-500)' }}>{estudiante.CarreraProfesional.NombreCarrera}</h6>
                </div>
                <div className='mt-4'>
                    <p><b>Codigo: </b>{estudiante.CodigoSunedu}</p>
                    <p><b>Email: </b>{estudiante.Persona.Email}</p>
                </div>
            </div>
        )
        ...
        return (
            <div className='card shadow-1'>
                <div className='text-center'>
                    <img style={{ borderRadius: 'var(--border-radius)', width: '8rem', height: '8rem', objectFit: 'cover' }} alt="Card" className=' mt-1 shadow-1' src={imagenURL} />
                    <h5 style={{ color: 'var(--surface-700)' }}>{docente.Persona.Paterno} {docente.Persona.Materno} {docente.Persona.Nombres}</h5>
                </div>
                <div className='mt-4'>
