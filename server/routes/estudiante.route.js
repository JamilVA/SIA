...
const { getEstudiante, crearEstudiante, actualizarEstudiante, buscarEstudiante, getNotas, getEstudianteByCodPersona, obtenerListaEstudiantes, getEstudiantesMatriculados, getEstudiantesMatriculadosCurso, getHistorialByDNI, actualizarDatosPersonales, insertarNotaCurso } = require('../controllers/estudiante.controller');
...
router.post('/insertar-nota', insertarNotaCurso)
